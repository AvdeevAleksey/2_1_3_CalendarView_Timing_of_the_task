...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnOkClocked (View view) {
        if (!(startDate==endDate)) {
            if (startDate > endDate) {
                Toast.makeText(MainActivity.this, getText(R.string.mistake), Toast.LENGTH_LONG).show();
                buttonChooseStartDate.setText(R.string.chooseStartDate);
                buttonChooseEndDate.setText(R.string.chooseEndDate);
            } else {
                Toast.makeText(MainActivity.this, getText(R.string.chooseStartDate) + startDateTxt + "\n" + getText(R.string.chooseEndDate) + endDateTxt, Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(MainActivity.this,getText(R.string.gross_error), Toast.LENGTH_LONG).show();
        }
    }
